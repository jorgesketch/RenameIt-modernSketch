...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/309e9feff086a78dc3574ed47251b63b.html";
...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  var data = Object(_lib_Utilities__WEBPACK_IMPORTED_MODULE_0__["parseData"])(context, true);

  // Return if there is no selection and show message
  if (data.selectionCount <= 0) {
    context.document.showMessage("Rename it: You need to select at least one frame or layer in a frame");
    return;
  }
  var options = {
...
/*!**********************************!*\
  !*** ./src/lib/RenameHelpers.js ***!
  \**********************************/
/*! exports provided: isArtboard, layerKey, collectNestedArtboards, isSymbolInstance, getSymbolName, hasLayerStyle, getLayerStyle, hasChildLayer, getChildLayer, getPositionalSequence, getSequenceType, setSequenceType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isArtboard", function() { return isArtboard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "layerKey", function() { return layerKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "collectNestedArtboards", function() { return collectNestedArtboards; });
...
function isArtboard(layer) {
  ...
  try {
    var behavior = Number(layer.groupBehavior());
  ...
  try {
    if (typeof MSArtboardGroup !== 'undefined' && layer instanceof MSArtboardGroup) return true;
  } catch (error) {} // eslint-disable-line no-empty
 ...
 */
function collectNestedArtboards(layer, collect) {
  var children;
  try {
  ...
  if (!children) return;
  var count = typeof children.count === 'function' ? children.count() : children.length;
  for (var i = 0; i < count; i += 1) {
    var child = typeof children.objectAtIndex === 'function' ? children.objectAtIndex(i) : children[i];
...
function parseData(context) {
  ...
  if (onlyArtboards) {
    ...
    contextData.forEach(function (el) {
      ...
      var scope = el;
      while (scope && !Object(_RenameHelpers__WEBPACK_IMPORTED_MODULE_0__["isArtboard"])(scope)) {
...
function getAllDescendants(layer) {
  var result = [layer];
  var sublayers = layer.containedLayers();
  for (var i = 0; i < sublayers.count(); i++) {
    getAllDescendants(sublayers[i]).forEach(function (l) {
...
function isCompatible() {
  return parseInt(sketch__WEBPACK_IMPORTED_MODULE_0___default.a.version.sketch, 10) >= 51;
}
function buildAlert() {
...
/***/ "./src/lib/renameitlib/FindReplace.js":
/*!********************************************!*\
  !*** ./src/lib/renameitlib/FindReplace.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FindReplace; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Rename; });
/* harmony import */ var upper_case__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! upper-case */ "./node_modules/upper-case/dist.es2015/index.js");
/* harmony import */ var lower_case__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lower-case */ "./node_modules/lower-case/dist.es2015/index.js");
/* harmony import */ var upper_case_first__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! upper-case-first */ "./node_modules/upper-case-first/dist.es2015/index.js");
/* harmony import */ var change_case__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! change-case */ "./node_modules/change-case/dist.es2015/index.js");
/* harmony import */ var titlecase__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! titlecase */ "./node_modules/titlecase/to-title-case.js");
/* harmony import */ var titlecase__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(titlecase__WEBPACK_IMPORTED_MODULE_4__);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
function _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
...
function currentLayer(newLayerName, layerName) {
  var name = newLayerName.replace(/%\*u%/gi, Object(upper_case__WEBPACK_IMPORTED_MODULE_0__["upperCase"])(layerName));
  name = name.replace(/%\*l%/gi, Object(lower_case__WEBPACK_IMPORTED_MODULE_1__["lowerCase"])(layerName));
  name = name.replace(/%\*t%/gi, titlecase__WEBPACK_IMPORTED_MODULE_4___default()(layerName));
  name = name.replace(/%\*uf%/gi, Object(upper_case_first__WEBPACK_IMPORTED_MODULE_2__["upperCaseFirst"])(layerName));
  name = name.replace(/%\*c%/gi, Object(change_case__WEBPACK_IMPORTED_MODULE_3__["camelCase"])(layerName));
  name = name.replace(/%\*pc%/gi, Object(change_case__WEBPACK_IMPORTED_MODULE_3__["paramCase"])(layerName));
...
/***/ "./src/lib/renameitlib/index.js":
/*!**************************************!*\
  !*** ./src/lib/renameitlib/index.js ***!
  \**************************************/
/*! exports provided: Rename, FindReplace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Rename__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Rename */ "./src/lib/renameitlib/Rename.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Rename", function() { return _Rename__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _FindReplace__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FindReplace */ "./src/lib/renameitlib/FindReplace.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "FindReplace", function() { return _FindReplace__WEBPACK_IMPORTED_MODULE_1__["default"]; });
